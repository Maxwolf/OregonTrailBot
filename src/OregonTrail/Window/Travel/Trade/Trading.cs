...
namespace OregonTrail.Travel.Trade
{
    ...
    public sealed class Trading : InputForm<TravelInfo>
    {
        ...
        private void UpdateTrade()
        {
            ...
            _tradeIndex = UserData.Game.Random.Next(_trades.Count);
        ...
        protected override void OnDialogResponse(DialogResponse reponse)
        {
            switch (reponse)
            {
                case DialogResponse.Yes:
                {
                    ...
                    UserData.Game.Vehicle.Inventory[_trades[_tradeIndex].WantedItem.Category].ReduceQuantity(
                        _trades[_tradeIndex].WantedItem.Quantity);

                    // Give the vehicle the item the trade said he would.
                    UserData.Game.Vehicle.Inventory[_trades[_tradeIndex].OfferedItem.Category].AddQuantity(
