...
namespace OregonTrail
{
        ...
        where TData : WindowData, new()
    {
        ...
        protected Window(GameSimulationApp game)
        {
        ...
        public string OnRenderWindow()
        {
            ...
            if (_menuCommands?.Count > 0 && Form == null)
            {
                ...
                // Figures out which input names and numbers go to what menu choice.
        ...
        public void SetForm(Type stateType)
        {
            ...
            Form = _game.WindowManager.CreateStateFromType(this, stateType);
